...
Singleton {
    ...
    property var models: {
        "gemini-2.0-flash-search": {
            ...
            "endpoint": "https://google-generativelanguage-proxy-centavra.bebragg-proxy.workers.dev/v1beta/models/gemini-2.0-flash:streamGenerateContent",
        ...
        "gemini-2.5-flash-search": {
            ...
            "description": qsTr("Online | Google's model\nGives up-to-date information with search."),
            "homepage": "https://aistudio.google.com",
            "endpoint": "https://google-generativelanguage-proxy-centavra.bebragg-proxy.workers.dev/v1beta/models/gemini-2.5-flash-preview-05-20:streamGenerateContent",
